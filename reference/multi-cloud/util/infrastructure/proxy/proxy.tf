...
module "aws_proxy" {
  source = "github.com/f5devcentral/f5-terraform//modules/providers/aws/infrastructure/proxy/standalone/1nic/util?ref=v0.0.8"
  purpose         = "${var.purpose}"
...
module "azure_proxy" {
  source = "github.com/f5devcentral/f5-terraform//modules/providers/azure/infrastructure/proxy/standalone/1nic/util?ref=v0.0.8"
  purpose           = "${var.purpose}"
  environment       = "${var.environment}"
  application       = "${var.application}"
  owner             = "${var.owner}"
