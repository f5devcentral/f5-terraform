...
applicationPoolAddress=${pool_address}
...
# POOL = STATIC
tmsh create ltm pool $${applicationPoolName} monitor http members add { $${applicationPoolAddress}:80 }
