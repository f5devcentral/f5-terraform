...
subnet2Name=${subnet_2_name}
subnet2Address=${subnet_2_address}
subnet2CidrBlock=${subnet_2_cidr_block}
subnet2Network=$${subnet2CidrBlock%/*}
subnet2Prefix=$${subnet2CidrBlock#*/}
subnet2Mtu=${subnet_2_mtu}
...
--vlan name:$${subnet2Name},nic:1.2,mtu:$${subnet2Mtu} \
--self-ip name:$${subnet2Name}_self,address:$${subnet2Address}/$${subnet2Prefix},vlan:$${subnet2Name},'allow:tcp:443 tcp:4353 tcp:22' \
...
analyticsAddress="analytics.example.com"
analyticsKey=123456
